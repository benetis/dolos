...
RSpec.describe Dolos do
  ...
  describe 'map_value' do
    ...
    it 'maps over two parsers' do
      parser = (string('hello') & string('world')).map_value { |value| value.map_each(&:upcase) }
    ...
    it 'maps over two parsers and uses them in a third' do
      loud_hello = (string('hello') & string('world')).map_value { |value| value.map_each(&:upcase) }
  ...
  describe 'map_captures' do
    it 'maps over parsers and converts them to ints' do
      parser = (string("1") & string("2") & string("3")).capture!.flatten.map_captures { |value| value.map_each(&:to_i) }
    ...
    it 'maps over groups and converts to ints' do
      first = (string("1") & string("2")).capture!.map_captures { |value| value.map_each(&:to_i) }
      second = (string("3") & string("4")).capture!.map_captures { |value| value.map_each(&:to_i) }
      parser = (first & second)
    ...
    it 'maps over groups to add and then multiply' do
      first = (string("1") & string("2")).capture!.map_captures { |digit| digit.map_each(&:to_i).reduce(:+) } # 3
      second = (string("3") & string("4")).capture!.map_captures { |digit| digit.map_each(&:to_i).reduce(:+) } # 7
  ...
  describe 'map' do
    it 'maps both values and captures' do
      parser = (string("1") & string("2")).capture!.map_each(&:to_i)
